!function (n) {
    ...
    !function () {
        ...
        var A = "Smooth Gestures Plus" != chrome.runtime.getManifest().short_name,
            ...
            O = {};
        if (A) chrome.extension.sendMessage(B, {storage: !0}, function (e) {
        ...
        var t = function () {
            ...
            var h = function (e) {
                if (o[e.button] = !1, d = 2 != e.button, e.target && "HTML" == e.target.nodeName && (document.height > window.innerHeight && e.clientX > window.innerWidth - 17 || document.width > window.innerWidth && e.clientY > window.innerHeight - 17)) H(); else {
                    if (r && s.postMessage({syncButton: {id: e.button, down: !0}}), a[e.button] = !0, i) {
                        if (2 == e.button) return void H();
                        i = !1
                    }
                    var t, n;
                    if (T(e), f.rocker && (a[0] ? 1 : 0) + (a[1] ? 1 : 0) + (a[2] ? 1 : 0) == 2) if (a[0] && (0 == e.button ? n = "L" : t = "L"), a[1] && (1 == e.button ? n = "M" : t = "M"), a[2] && (2 == e.button ? n = "R" : t = "R"), g.callback || O.validGestures.r[t] && O.validGestures.r[t][n]) return r = {
                        timeout: setTimeout(function () {
                            r = !1
                        }, 500)
                    }, S("r" + t + n), window.getSelection().removeAllRanges(), d = !0, o[0] = !0, o[1] = !0, o[2] = !0, e.preventDefault(), void e.stopPropagation();
                    O.contextOnLink && 2 == e.button && N(e.target) || 0 == O.holdButton && 0 == e.button && "SELECT" == e.target.nodeName || (0 != O.holdButton || "0" == l[0] && "0" == l[1] && "0" == l[2] && !u) && (0 == O.holdButton && 0 == e.button && "IMG" == e.target.nodeName && e.preventDefault(), 1 == e.button && (O.validGestures.r.M || window.SG.callback) && -1 != navigator.platform.indexOf("Win") && e.preventDefault(), L({
                        x: e.clientX,
                        y: e.clientY
                    }, e.target, e.button == O.holdButton, (a[0] ? 1 : 0) + (a[1] ? 1 : 0) + (a[2] ? 1 : 0) == 1 && (g.callback || O.validGestures.r && (a[0] && O.validGestures.r.L || a[1] && O.validGestures.r.M || a[2] && O.validGestures.r.R)), e.button == O.holdButton && (g.callback || O.validGestures.w)))
                }
            }, y = function (e) {
                if (e.button == O.holdButton && (f.line && T(e, !0), f.line && "" != f.line.code && (S(f.line.code), e.preventDefault(), 0 == e.button && window.getSelection().removeAllRanges(), 2 == e.button && (d = !0), o[e.button] = !0)), f.line = null, f.wheel = null, 2 != e.button && (d = !0), !(2 != e.button || i || d || a[0] || a[1] || -1 != navigator.platform.indexOf("Win"))) {
                    i = !0, setTimeout(function () {
                        i = !1
                    }, 600);
                    var t = {x: e.screenX, y: e.screenY};
                    navigator.userAgent.match(/linux/i) && (e.screenX < window.screenLeft + Math.round(e.clientX * window.devicePixelRatio) || 0 == window.screenLeft && e.screenY < 55 + window.screenTop + Math.round(e.clientY * window.devicePixelRatio)) && (t.x += window.screenLeft, t.y += window.screenTop), console.log("SEND NATIVE", t), s.postMessage({nativeport: {rightclick: t}})
                }
                o[e.button] && e.preventDefault(), a[e.button] = !1, r && s.postMessage({
                    syncButton: {
                        id: e.button,
                        down: !1
                    }
                }), a[0] || a[2] || (f.rocker = null), f.rocker || H()
            }, p = function (e) {
                a = {}
            }, v = function (e) {
                o[e.button] && (e.preventDefault(), e.stopPropagation()), o[e.button] = !1
            }, b = function (e) {
                (d || a[2] && (f.line || f.rocker || f.wheel)) && !i ? (e.preventDefault(), e.stopPropagation(), d = !1) : (H(), a = {})
            }, x = function (e) {
                ...
                if (16 == e.keyCode || 17 == e.keyCode || 18 == e.keyCode || 0 == e.keyCode || 91 == e.keyCode || 92 == e.keyCode || 93 == e.keyCode) {
                    ...
                    if (null != o) {
                        ...
                        t = function (e) {
                            l = l.substr(0, o) + "0" + l.substr(o + 1), window.removeEventListener("keyup", t, !0)
                        };
                        window.addEventListener("keyup", t, !0)
                    }
                    l = n
                } else (g.callback || ("0000" != n || null == m || "INPUT" != m.nodeName && "TEXTAREA" != m.nodeName) && O.validGestures.k && O.validGestures.k[n] && 0 <= O.validGestures.k[n].indexOf(e.keyIdentifier + ":" + e.keyCode)) && (L(null, null, !1, !1, !1), S("k" + n + ":" + e.keyIdentifier + ":" + e.keyCode), e.preventDefault(), e.stopPropagation())
            }, P = function (e) {
                e.target.nodeName && (m = e.target)
            }, E = function (e) {
                e.target.nodeName && (m = null)
            }, L = function (e, t, n, o, i, l) {
                if (H(), f.events || (window.addEventListener("mousemove", T, !0), window.addEventListener("mousewheel", D, !0), f.events = !0), "mail.google.com" == location.hostname) {
                ...
                if (f.startPoint || (f.startPoint = {
                    ...
                    s == r ? f.line.dirPoints[f.line.dirPoints.length - 1] = n : (25 < Math.abs(i) || 25 < Math.abs(l)) && (t || s.match(/^[RLUD]$/)) && (f.line.possibleDirs && (f.line.possibleDirs = f.line.possibleDirs[s]), f.line.possibleDirs || g.callback ? (f.line.code += s, f.line.dirPoints.push(n)) : (H(), d = !0))
                }
            }, C = function (e, t) {
                var n = t.x - e.x, o = t.y - e.y;
                return Math.abs(n) > 2 * Math.abs(o) ? 0 < n ? "R" : "L" : Math.abs(o) > 2 * Math.abs(n) ? 0 < o ? "D" : "U" : o < 0 ? 0 < n ? "9" : "7" : 0 < n ? "3" : "1"
            }, D = function (e) {
                if ("IFRAME" != e.target.nodeName && "FRAME" != e.target.nodeName || H(), T(e), f.wheel && 0 != e.wheelDelta) {
                    var t = 0 < e.wheelDelta ? "U" : "D";
                    (g.callback || O.validGestures.w[t]) && (r = {
                        timeout: setTimeout(function () {
                            r = !1
                        }, 500)
                    }, S("w" + t), 2 == O.holdButton && (d = !0), 0 == O.holdButton && window.getSelection().removeAllRanges(), o[O.holdButton] = !0, e.preventDefault(), e.stopPropagation())
                }
            }, S = function (e) {
                if (e) if (g.callback) g.callback(e), g.callback = null; else {
                    var t = {
                        gesture: e,
                ...
                if (w.getContext) {
                    var e = Date.now(), t = w.getContext("2d");
                    if (t.clearRect(0, 0, w.width, w.height), f.line) {
                        if (t.strokeStyle = "rgba(" + O.trailColor.r + "," + O.trailColor.g + "," + O.trailColor.b + "," + O.trailColor.a + ")", t.lineWidth = O.trailWidth, t.lineCap = "butt", t.lineJoin = "round", t.shadowBlur = O.trailWidth, t.shadowColor = "rgba(255,255,255,.3)", O.trailLegacy) {
                            t.beginPath(), t.moveTo(f.line.points[0].x, f.line.points[0].y);
                            for (r = 1; r < f.line.points.length; r++) t.lineTo(f.line.points[r].x, f.line.points[r].y);
                            t.stroke()
                        } else {
                            ...
                            t.beginPath(), 0 < f.line.code.length && ("L" == f.line.code[0] || "R" == f.line.code[0] ? n.y = f.line.dirPoints[1].y : n.x = f.line.dirPoints[1].x), t.moveTo(n.x, n.y);
                            for (var r = 1; r < f.line.code.length; r++) {
                                ...
                                if ("L" == s || "R" == s) if ("L" == a || "R" == a) {
                                    ...
                                    t.arcTo(d.x, n.y, d.x, c.y, u), u = Math.min(Math.abs(c.x - d.x), Math.abs(c.y - n.y) - u), t.arcTo(d.x, c.y, c.x, c.y, u), n.x = (d.x + c.x) / 2, n.y = c.y, t.lineTo(n.x, n.y)
                                } else {
                                    var m = c.y;
                                    "L" != f.line.code[r + 1] && "R" != f.line.code[r + 1] || (m = f.line.dirPoints[r + 2].y);
                                    u = Math.min(Math.abs(c.x - n.x), Math.abs(m - n.y) / 2);
                                    t.arcTo(c.x, n.y, c.x, c.y, .8 * u), n.x = c.x, n.y = (n.y + m) / 2, t.lineTo(n.x, n.y)
                                } else if ("L" == a || "R" == a) {
                                    var h = c.x;
                                    "U" != f.line.code[r + 1] && "D" != f.line.code[r + 1] || (h = f.line.dirPoints[r + 2].x);
                                    u = Math.min(Math.abs(h - n.x) / 2, Math.abs(c.y - n.y));
                                    t.arcTo(n.x, c.y, c.x, c.y, .8 * u), n.x = (n.x + h) / 2, n.y = c.y, t.lineTo(n.x, n.y)
                                } else {
                                    u = Math.min(Math.abs(c.x - n.x) / 2, Math.abs(d.y - n.y));
                                    t.arcTo(n.x, d.y, c.x, d.y, u), u = Math.min(Math.abs(c.x - n.x) - u, Math.abs(c.y - d.y)), t.arcTo(c.x, d.y, c.x, c.y, u), n.x = c.x, n.y = (d.y + c.y) / 2, t.lineTo(n.x, n.y)
                                }
                            }
                            0 < f.line.code.length && (n = f.line.dirPoints[f.line.dirPoints.length - 1], t.lineTo(n.x, n.y)), t.stroke(), (f.line.possibleDirs && f.line.possibleDirs[l] || g.callback) && ("3" == l || "7" == l ? t.lineTo((n.x - n.y + o.x + o.y) / 2, (-n.x + n.y + o.x + o.y) / 2) : "1" != l && "9" != l || t.lineTo((n.x + n.y + o.x - o.y) / 2, (n.x + n.y - o.x + o.y) / 2), t.stroke())
                        }
                        z.lasttime = Date.now(), z.runtime = .9 * (z.runtime || 10) + .1 * (z.lasttime - e)
                    }
                }
            }, R = function () {
                e || (e = !0, window.addEventListener("mousedown", h, !0), window.addEventListener("mouseup", y, !0), window.addEventListener("dragend", p, !0), window.addEventListener("click", v, !0), window.addEventListener("contextmenu", b, !0), window.addEventListener("selectstart", x, !0), window.addEventListener("resize", M, !0), window.addEventListener("keydown", k, !0))
            };
            g.disable = function () {
                e && (e = !1, window.removeEventListener("mousedown", h, !0), window.removeEventListener("mouseup", y, !0), window.removeEventListener("dragend", p, !0), window.removeEventListener("click", v, !0), window.removeEventListener("contextmenu", b, !0), window.removeEventListener("selectstart", x, !0), window.removeEventListener("resize", M, !0), window.removeEventListener("keydown", k, !0), s.onMessage.removeListener(t), s.onDisconnect.removeListener(g.disable))
            }, g.enabled = function () {
                return e
            }, function () {
                ...
                window.addEventListener("focus", P, !0), window.addEventListener("blur", E, !0), g.connect(), (w = document.createElement("canvas")).style && (w.style.position = "fixed", w.style.top = 0, w.style.left = 0, w.style.zIndex = 999999999, w.style.background = "transparent", w.style.margin = "0", w.style.padding = "0"), M(), (c = document.createElement("div")).style.clear = "both"
            }()
        };
        if (window.SGinjectscript && window.SGinjectscript.constructor == HTMLScriptElement) {
            var n = window.SGinjectscript.src.match(/([^a-p]|^)([a-p]{32})([^a-p]|$)/);
            n && (window.SGextId = n[2]);
            for (var o = document.querySelectorAll("script[src^=chrome-extension\\:\\/\\/]"), i = 0; i < o.length; i++) o[i].parentNode.removeChild(o[i])
        }
        var l = function () {
