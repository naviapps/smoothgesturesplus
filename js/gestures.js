    ...
    !(function () {
      ...
      if (A)
        ...
        chrome.storage.onChanged.addListener(function (e, t) {
          if ('local' == t) for (key in e) settings[key] = e[key].newValue;
        });
      }
      ...
      var SmoothGestures = function () {
        ...
        var t = function (e) {
          'enable' in e && (e.enable ? enable() : _this.disable()),
            ...
            e.windowBlurred && ((a = {}), (o = {}), (d = true), endGesture()),
            e.chain &&
              (L(
                e.chain.startPoint,
                e.chain.startPoint
              ...
              e.chain.buttonDown &&
                ...
                null == a[0] && (a[0] = e.chain.buttonDown[0]),
                null == a[1] && (a[1] = e.chain.buttonDown[1]),
                null == a[2] && (a[2] = e.chain.buttonDown[2]))),
        ...
        var mouseDownCapture = function (e) {
          if (
            ...
            if (
              (r &&
                port.postMessage({ syncButton: { id: e.button, down: true } }),
              (a[e.button] = true),
              i)
            ) {
            ...
            if (
              (T(e),
              f.rocker && (a[0] ? 1 : 0) + (a[1] ? 1 : 0) + (a[2] ? 1 : 0) == 2)
            )
              if (
                (a[0] && (0 == e.button ? (n = 'L') : (t = 'L')),
                a[1] && (1 == e.button ? (n = 'M') : (t = 'M')),
                a[2] && (2 == e.button ? (n = 'R') : (t = 'R')),
                _this.callback ||
                  (settings.validGestures.r[t] &&
                    settings.validGestures.r[t][n]))
              )
                return (
                  (r = {
            ...
            (settings.contextOnLink && 2 == e.button && N(e.target)) ||
              (0 == settings.holdButton &&
                0 == e.button &&
              ...
              ((0 != settings.holdButton ||
                ...
                L(
                  ...
                  e.target,
                  e.button == settings.holdButton,
                  (a[0] ? 1 : 0) + (a[1] ? 1 : 0) + (a[2] ? 1 : 0) == 1 &&
                    (_this.callback ||
                      (settings.validGestures.r &&
                        ((a[0] && settings.validGestures.r.L) ||
                          (a[1] && settings.validGestures.r.M) ||
                          (a[2] && settings.validGestures.r.R)))),
                  e.button == settings.holdButton &&
                    (_this.callback || settings.validGestures.w),
                )));
          }
        };
        var y = function (e) {
          if (
            (e.button == settings.holdButton &&
              ...
              f.line &&
                ...
                (S(f.line.code),
                e.preventDefault(),
                0 == e.button && window.getSelection().removeAllRanges(),
                2 == e.button && (d = true),
                (o[e.button] = true))),
            (f.line = null),
            (f.wheel = null),
        ...
        var keyDownCapture = function (e) {
          ...
          if (
            ...
            (_this.callback ||
              (('0000' != n ||
                null == focus ||
                ('INPUT' != focus.nodeName && 'TEXTAREA' != focus.nodeName)) &&
        ...
        const focusCapture = function (t) {
          if (t.target.nodeName) focus = t.target;
        };

        const blurCapture = function (e) {
        ...
        var L = function (e, t, n, o, i, l) {
          if (
            ...
            var r = document.body.children[1],
              s = function () {
                endGesture(),
                  r.removeEventListener('DOMSubtreeModified', s, true);
              };
        ...
        var T = function (e, t) {
          if (
            ...
            (f.rocker || f.wheel) &&
              (0 < Math.abs(e.clientX - f.startPoint.x) ||
                2 < Math.abs(e.clientY - f.startPoint.y)) &&
            ...
            s == r
              ...
              : (25 < Math.abs(i) || 25 < Math.abs(l)) &&
                ...
                f.line.possibleDirs || _this.callback
        ...
        var wheelGesture = function (t) {
          ...
          if (f.wheel && 0 != t.wheelDelta) {
            ...
            (_this.callback || settings.validGestures.w[dir]) &&
              ...
              S('w' + dir),
              2 == settings.holdButton && (d = true),
              0 == settings.holdButton &&
                window.getSelection().removeAllRanges(),
              (o[settings.holdButton] = true),
              t.preventDefault(),
              t.stopPropagation());
          }
        };
          ...
          if (e)
            if (_this.callback) _this.callback(e), (_this.callback = null);
              ...
              if (
                ...
                settings.selectToLink && f.selection)
              ) {
              ...
              for (n = 0; n < f.targets.length; n++) {
                ...
                f.targets[n].setAttribute('gestureid', i),
                  ...
                  'IMG' == f.targets[n].nodeName &&
                    t.images.push({ src: f.targets[n].src, gestureid: i });
              }
              r && (t.buttonDown = a), port.postMessage(t);
              f.targets;
            }
          if ('w' == e[0]) (f.line = null), (f.rocker = null);
          else if ('r' == e[0]) (f.line = null), (f.wheel = null);
          else {
        ...
        var z = function () {
          ...
          if ((ctx.clearRect(0, 0, canvas.width, canvas.height), f.line)) {
            if (
              ((ctx.strokeStyle =
                'rgba(' +
              ...
              ctx.beginPath(),
                ctx.moveTo(f.line.points[0].x, f.line.points[0].y);
              for (r = 1; r < f.line.points.length; r++)
                ctx.lineTo(f.line.points[r].x, f.line.points[r].y);
              ctx.stroke();
            } else {
              var n = { x: f.line.dirPoints[0].x, y: f.line.dirPoints[0].y },
                ...
                l = C(i, o);
              25 < Math.max(Math.abs(o.x - i.x), Math.abs(o.y - i.y)) &&
                l.match(/^[1379]$/);
              ctx.beginPath(),
                0 < f.line.code.length &&
                  ('L' == f.line.code[0] || 'R' == f.line.code[0]
      ...
      if (
        ...
        var match = window.SGinjectscript.src.match(
          /([^a-p]|^)([a-p]{32})([^a-p]|$)/,
        );
