...
function n(t, r) {
  ...
  for (e = l[0], s = l[1], c = l[2], a = l[3], o = l[4], i = 0; i <= 79; i++)
    16 <= i &&
      (h[i] =
        ((h[i - 3] ^ h[i - 8] ^ h[i - 14] ^ h[i - 16]) << 1) | ((h[i - 3] ^ h[i - 8] ^ h[i - 14] ^ h[i - 16]) >>> 31)),
      (n =
        (((e << 5) | (e >>> 27)) +
          (n =
            i <= 19
...
'undefined' != typeof module && module.exports && (module.exports = sjcl),
  (sjcl.bitArray = {
    bitSlice: function (t, r, i) {
      return (
        (t = sjcl.bitArray.d(t.slice(r / 32), 32 - (31 & r)).slice(1)), void 0 === i ? t : sjcl.bitArray.clamp(t, i - r)
      );
    },
    ...
    d: function (t, r, i, n) {
      ...
      return (
        ...
        n.push(sjcl.bitArray.partial((r + t) & 31, 32 < r + t ? i : n.pop(), 1)),
        n
      );
    },
    g: function (t, r) {
  ...
  (sjcl.codec.hex = {
    ...
    toBits: function (t) {
      var r,
        i,
        n = [];
      for (i = (t = t.replace(/\s|0x/g, '')).length, t += '00000000', r = 0; r < t.length; r += 8)
  ...
  (sjcl.hash.sha1.prototype = {
    ...
    update: function (t) {
      ...
      for (
        r = this.a, t = this.a = r + sjcl.bitArray.bitLength(t), r = (this.blockSize + r) & -this.blockSize;
        r <= t;
        r += this.blockSize
      )
