...
function n(t, r) {
    var i, n, e, s, c, a, o, h = r.slice(0), l = t.c;
    for (e = l[0], s = l[1], c = l[2], a = l[3], o = l[4], i = 0; i <= 79; i++) 16 <= i && (h[i] = (h[i - 3] ^ h[i - 8] ^ h[i - 14] ^ h[i - 16]) << 1 | (h[i - 3] ^ h[i - 8] ^ h[i - 14] ^ h[i - 16]) >>> 31), n = (e << 5 | e >>> 27) + (n = i <= 19 ? s & c | ~s & a : i <= 39 ? s ^ c ^ a : i <= 59 ? s & c | s & a | c & a : i <= 79 ? s ^ c ^ a : void 0) + o + h[i] + t.f[Math.floor(i / 20)] | 0, o = a, a = c, c = s << 30 | s >>> 2, s = e, e = n;
...
'undefined' != typeof module && module.exports && (module.exports = sjcl), sjcl.bitArray = {
    bitSlice: function (t, r, i) {
        ...
        return (-32 & (r + i - 1 ^ r) ? t[r / 32 | 0] << 32 - n ^ t[r / 32 + 1 | 0] >>> n : t[r / 32 | 0] >>> n) & (1 << i) - 1
    }, concat: function (t, r) {
        if (0 === t.length || 0 === r.length) return t.concat(r);
        var i = t[t.length - 1], n = sjcl.bitArray.getPartial(i);
        return 32 === n ? t.concat(r) : sjcl.bitArray.d(r, n, 0 | i, t.slice(0, t.length - 1))
        ...
        return r &= 31, 0 < i && r && (t[i - 1] = sjcl.bitArray.partial(r, t[i - 1] & 2147483648 >> r - 1, 1)), t
        ...
        for (e = 0; e < t.length; e++) n.push(i | t[e] >>> r), i = t[e] << 32 - r;
        return e = t.length ? t[t.length - 1] : 0, t = sjcl.bitArray.getPartial(e), n.push(sjcl.bitArray.partial(r + t & 31, 32 < r + t ? i : n.pop(), 1)), n
    }, g: function (t, r) {
    ...
    fromBits: function (t) {
        ...
        var r, i = [], n = 0;
        for (r = 0; r < t.length; r++) n = n << 8 | t.charCodeAt(r), 3 == (3 & r) && (i.push(n), n = 0);
    ...
    t ? (this.c = t.c.slice(0), this.b = t.b.slice(0), this.a = t.a) : this.reset()
    ...
    finalize: function () {
        var t, r = this.b, i = this.c;
        for (t = (r = sjcl.bitArray.concat(r, [sjcl.bitArray.partial(1, 1)])).length + 2; 15 & t; t++) r.push(0);
        for (r.push(Math.floor(this.a / 4294967296)), r.push(0 | this.a); r.length;) n(this, r.splice(0, 16));
        return this.reset(), i
    },
