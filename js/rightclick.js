!function () {
    ...
    var i = function (t, e) {
        ...
        t = -1 != navigator.platform.indexOf('CrOS'), e = -1 != navigator.platform.indexOf('Linux');
            ...
            $('#doubleclick, #chromeosdouble').click(function () {
                ...
                i({blockDoubleclickAlert: false}), chrome.permissions.request({permissions: ['nativeMessaging']}, function (t) {
                    if (t || n.forceInstallRightclick) {
                        ...
                        o ? (e.setAttribute('href', '/nat/SmoothGesturesPlusExtras-0.7.dmg'), e.setAttribute('download', 'SmoothGesturesPlusExtras-0.7.dmg')) : (e.setAttribute('href', '/nat/smoothgesturesplus-extras-0.6.tar.gz'), e.setAttribute('download', 'smoothgesturesplus-extras-0.6.tar.gz')), e.click(), $('p, div').css({display: 'none'}), $('#arrow, #instruct').css({display: 'block'})
                    }
                })
            }), o && $('#instruct').html('<ul><li>Open the dmg file</li><li>Right-click the app > Open</li></ul>'), e && $('#instruct').html('<ul><li>Extract the tar file</li><li>Run install.py</li></ul>'), t && ($('#extras').hide(), $('#chromeos').show()), n.forceInstallRightclick && $('#installplugin').click()
        })
    }
}();