...
if (bg.popupMessage == 'updated') {
  $('body').append(
    $('<p>').text(chrome.i18n.getMessage('popup_updated', bg.extVersion)),
  )
    ...
    bg.getTabStatus(tab.id, function (stat) {
      if (stat == 'broken') {
        $('body')
          ...
          .append(
            $('<h1>').text(chrome.i18n.getMessage('popup_status_broken_short')),
          )
        ...
        $('body')
          ...
          .append(
            $('<h1>').text(chrome.i18n.getMessage('popup_status_unable_short')),
          )
          .append(
            $('<p>').text(chrome.i18n.getMessage('popup_status_blocked_1')),
          )
