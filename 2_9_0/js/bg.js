  ...
  function (e, t, n) {
    !(function () {
      ...
      chrome.storage.local.get(null, function (e) {
        ...
        (l.init = function () {
          for (key in (r.firstinstalled ||
            ...
            (r.sync = { firstinstalled: !0 })),
          JSON.parse(k['Smooth Gestures'].settings)))
            r.sync[key] = !0
          if (
            ((r.sync.gestures = !0), (r.sync.customactions = !0), !s.installed)
          ) {
      ...
      var d = -1 != navigator.platform.indexOf('Mac'),
        u = -1 != navigator.platform.indexOf('Linux'),
        m = null,
        h = {},
        f = { active: null, prevActive: null, closed: [], tab: {} },
        b = {},
        w = null,
        p = null,
        o = null,
        v = 1745208e3 < Date.now() / 1e3,
        k = { 'Smooth Gestures': {} }
              ...
              chrome.tabs.create(
                {
                  url:
                    'view-source:' +
                    (h[t].detail.url ? h[t].detail.url : e.url),
                  windowId: e.windowId,
                  index: e.index + 1,
                },
                n,
      ...
      ;(L['clone-tab'] = function (e, t, n) {
        ...
        (L['hide-image'] = function (e, t, n) {
          h[e].postMessage(
            { action: { id: 'hide-image', images: n.images } },
            t,
          )
        }),
          ...
          if (f.active != e) {
            for (id in h)
              f.active == h[id].detail.tabId &&
                h[id].postMessage({ windowBlurred: !0 })
      ...
      chrome.runtime.onUpdateAvailable.addListener(function (e) {
        ...
        (window.isNative = function () {
          return (
            !!m &&
            (m.version ? { loaded: !0, version: m.version } : { loaded: !1 })
          )
        })
    })()
  },
