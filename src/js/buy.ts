...
const a = () => {
  $(() => {
    const s = 336 - Math.ceil((Date.now() - settings.firstinstalled) / 1000 / 60 / 60);
    $('body')
      .append(
        $('<div class=section>')
          ...
          .append(
            $('<div>')
              ...
              .html(
                '<span class=sglogo><img src="/img/icon48.png" alt=""> <span class=sgtitle>Smooth<br>Gestures <span class=sgplus>plus</span></span></span>',
              ),
          )
          .append(
            ...
            $('<div class="upgradeplus">').append(
              $(
                ...
                .click(() => {
                  chrome.tabs.create(
                    {
                      url: `https://smoothgesturesplus.com/id/?clid=${settings.id}&fi=${
                        settings.firstinstalled
                      }&n=/pay/`,
                    },
                    () => {
                      window.close();
